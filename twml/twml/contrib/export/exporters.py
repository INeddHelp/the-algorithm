...
class _AllSavedModelsExporter(tf.estimator.Exporter):
    ...
    def export(self, estimator, export_path, checkpoint_path, eval_result,
        ...
        if self._backup_checkpoints:
            ...
            twml.util.backup_checkpoint(checkpoint_path,
                                        backup_path,
                                        empty_backup=False)
...
class BestExporter(tf.estimator.BestExporter):
    ...
    def __init__(
        ...
        self._saved_model_exporter = _AllSavedModelsExporter(
            name, input_receiver_fn_map, backup_checkpoints, assets_extra,
            as_text)
...
class LatestExporter(tf.estimator.LatestExporter):
    ...
    def __init__(
        ...
        super(LatestExporter,
              self).__init__(name, serving_input_receiver_fn, assets_extra,
                             as_text, exports_to_keep)
