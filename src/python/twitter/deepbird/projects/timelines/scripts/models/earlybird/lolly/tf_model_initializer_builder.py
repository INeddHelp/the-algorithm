...
class TFModelInitializerBuilder:
    ...
    def build(self, lolly_model_reader):
        ...
        self._set_discretized_features(
            features["discretized"], tf_model_initializer)

        self._dedup_binary_features(
            features["binary"], features["discretized"])
    ...
    def _dedup_binary_features(binary_features, discretized_features):
        [binary_features.pop(feature_name)
         for feature_name in discretized_features]
