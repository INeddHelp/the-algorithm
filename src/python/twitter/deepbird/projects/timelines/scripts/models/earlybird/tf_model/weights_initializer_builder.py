...
class TFModelWeightsInitializerBuilder(object):
    ...
    def build(self, tf_model_initializer):
        ...
        self._set_discretized_feature_weights(initial_weights,
                                              features["discretized"])

        return tf.constant_initializer(
            features["bias"]), twml.contrib.initializers.PartitionConstant(
                initial_weights)
    ...
    def _set_discretized_feature_weights(self, initial_weights,
